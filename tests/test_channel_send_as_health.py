...
class _SendAsProbeClient:
    def __init__(self, available_ids, *, saveable_ids=None, reject_get_send_as=False, personal_id=301299112):
    ...
    async def __call__(self, request):
        ...
        if request_name == "SaveDefaultSendAsRequest" and send_as is not None:
            ...
            if send_as_id != self.personal_id and send_as_id not in self.saveable_ids:
