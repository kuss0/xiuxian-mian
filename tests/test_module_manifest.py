...
class ModuleManifestTests(unittest.TestCase):
    ...
    def test_reply_family_maps_to_source_module(self):
        ...
        self.assertEqual("慕兰烽烟", module_manifest.get_module_name_for_reply_family("mulan_collect"))
        self.assertEqual("慕兰烽烟", module_manifest.get_module_name_for_reply_family("mulan_judge"))
        self.assertEqual("慕兰烽烟", module_manifest.get_module_name_for_reply_family("mulan_publish"))
        self.assertEqual("慕兰烽烟", module_manifest.get_module_name_for_reply_family("mulan_support"))
    ...
    def test_real_message_samples_match_manifest_replay_modules(self):
        ...
        self.assertEqual("慕兰烽烟", module_manifest.get_module_name_for_replay_module("mulan"))
    ...
    def test_module_readiness_backlog_classifies_existing_modules(self):
        ...
        self.assertEqual(106, summary["totals"]["covered_sample_families"])
        ...
        self.assertEqual(module_manifest.READINESS_SAMPLE_COMPLETE, rows["慕兰烽烟"]["readiness"])
        self.assertEqual([], rows["慕兰烽烟"]["missing_sample_families"])
        ...
        self.assertEqual(module_manifest.READINESS_SAMPLE_PARTIAL, rows["婉心封魂"]["readiness"])
        self.assertEqual(["wanxin_moon_join"], rows["婉心封魂"]["missing_sample_families"])
        self.assertEqual(module_manifest.READINESS_SAMPLE_COMPLETE, rows["小世界"]["readiness"])
