...
from .runtime import consume_unseen_startup_alerts, redeem_ui_login_token, send_audit_log, touch_ui_session
from .state import (
...
def render_ui_page(message="", selected_send_as_id=None, session_token=None):
    ...
    return (
        ...
        "      <div class='form-label'>配置游戏群聊、允许处理的 bot ID，以及固定话题 ID。话题留空或填 0 表示不使用。</div>"
        ...
        "document.querySelectorAll('.modal-card').forEach(function(element){element.addEventListener('click',function(event){event.stopPropagation();});});"
