    ...
    with use_identity(send_as_id):
        ...
        snapshot = {
            ...
            "timers": {
                ...
                "next_guanxing_notify_time": fmt_abs_ts(identity_state.get("next_guanxing_notify_time", 0)),
            ...
            "guanxing_slot_end_at": fmt_abs_ts(identity_state.get("guanxing_slot_end_at", 0)),
            "guanxing_last_seen_at": fmt_abs_ts(identity_state.get("guanxing_last_seen_at", 0)),
            "guanxing_matched_keyword": identity_state.get("guanxing_matched_keyword") or "",
            "guanxing_last_evolution_value": identity_state.get("guanxing_last_evolution_value") or "",
        }
    return snapshot
