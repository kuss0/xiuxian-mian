...
# A sermon restores roughly 15-16 faith but costs 8,000 cultivation.  Waiting
# until the deficit can use most of that recovery avoids spending it on routine
# one-to-six point drift.
SMALL_WORLD_PREACH_FAITH_RATIO_TRIGGER = 0.85
