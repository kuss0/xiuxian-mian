...
ACTION_SPECS = {
    ...
    "wanxin_panel": {
        "commands": (CMD_WANXIN_STATUS, CMD_WANXIN_HELP),
        "kind": ACTION_KIND_STATUS,
        "label": "婉心状态",
        "max_attempts": 1,
        "ttl_sec": 10 * 60,
    ...
    "wanxin_moon_panel": {
        "commands": (CMD_WANXIN_MOON_STATUS,),
        "kind": ACTION_KIND_STATUS,
        "label": "婉影状态",
        "max_attempts": 1,
        "ttl_sec": 10 * 60,
    ...
    "wanxin_moon_greet": {
        "commands": (CMD_WANXIN_MOON_GREET,),
        "kind": ACTION_KIND_HIGH_RISK,
        "label": "婉影问安",
        "max_attempts": 1,
        "ttl_sec": 24 * 3600,
    ...
    "wanxin_commission": {
        "commands": (CMD_WANXIN_PUBLISH_COMMISSION,),
        "kind": ACTION_KIND_CHAIN,
        "label": "发布解咒委托",
        "max_attempts": 1,
        "ttl_sec": 24 * 3600,
    ...
    "wanxin_cancel": {
        "commands": (CMD_WANXIN_CANCEL_COMMISSION,),
        "kind": ACTION_KIND_CHAIN,
        "label": "取消解咒委托",
        "max_attempts": 1,
        "ttl_sec": 10 * 60,
    ...
    "wanxin_accept": {
        "commands": (CMD_WANXIN_ACCEPT_COMMISSION,),
        "kind": ACTION_KIND_CHAIN,
        "label": "接取解咒委托",
        "max_attempts": 1,
        "ttl_sec": 24 * 3600,
    ...
    "wanxin_assist_identify": {
        "commands": (CMD_WANXIN_ASSIST_IDENTIFY,),
        "kind": ACTION_KIND_HIGH_RISK,
        "label": "辨认咒纹",
        "max_attempts": 1,
        "ttl_sec": 4 * 3600,
    },
    "wanxin_assist_banner": {
        "commands": (CMD_WANXIN_ASSIST_BANNER,),
        "kind": ACTION_KIND_HIGH_RISK,
        "label": "借幡镇魂",
        "max_attempts": 1,
        "ttl_sec": 6 * 3600,
    ...
    "wanxin_assist_strip": {
        "commands": (CMD_WANXIN_ASSIST_STRIP,),
        "kind": ACTION_KIND_HIGH_RISK,
        "label": "剥离咒源",
        "max_attempts": 1,
        "ttl_sec": 8 * 3600,
...
FAMILY_TO_ACTION_KEYS = {
    ...
    "wanxin_moon_panel": ("wanxin_moon_panel",),
    "wanxin_moon_greet": ("wanxin_moon_greet",),
    "wanxin_moon_seal": ("wanxin_moon_seal",),
    "wanxin_moon_join": ("wanxin_moon_join",),
    "wanxin_panel": ("wanxin_panel",),
    "wanxin_visit": ("wanxin_visit",),
    "wanxin_protect": ("wanxin_protect",),
    "wanxin_deduce": ("wanxin_deduce",),
    "wanxin_commission": ("wanxin_commission",),
    "wanxin_cancel": ("wanxin_cancel",),
    "wanxin_accept": ("wanxin_accept",),
    "wanxin_assist_identify": ("wanxin_assist_identify",),
    "wanxin_assist_banner": ("wanxin_assist_banner",),
    "wanxin_assist_strip": ("wanxin_assist_strip",),
...
def get_timing_blocked_until(command, send_as_id=None, now=None):
    action_key = resolve_action_key(command)
    if not action_key or not has_identity(send_as_id):
        return 0.0, ""
    now = float(now if now is not None else time.time())
