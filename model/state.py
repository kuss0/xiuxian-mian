...
IDENTITY_RUNTIME_COLUMNS = [
    ...
    "duel_target", "duel_total_count", "duel_completed_count", "duel_reserve_xiuwei", "duel_window_start_minute", "duel_window_end_minute", "duel_daily_limit_day", "duel_daily_limited_targets", "duel_reply_to_msg_id", "duel_reply_due_at", "duel_open_msg_id", "duel_magic_due_at", "duel_magic_sent_at", "duel_started_at", "duel_phaseful_retry_count", "duel_last_msg_id", "duel_last_result", "duel_last_error", "duel_unequip_prepared",
