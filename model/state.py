...
IDENTITY_RUNTIME_COLUMNS = [
    ...
    "second_soul_phase", "second_soul_choice_strategy", "second_soul_heart_demon_msg_id", "second_soul_heart_demon_chat_id", "second_soul_heart_demon_choice_msg_id", "second_soul_heart_demon_notified", "second_soul_status_msg_id", "second_soul_train_msg_id",
