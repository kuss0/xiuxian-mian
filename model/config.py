...
EXPLORE_RIFT_REBIRTH_REPLY_TIMEOUT_SEC = 6 * 60
MODULE_PROTECT_SEC = 30            # 状态机模块执行后的保护间隔
POST_SUMMARY_WAIT_SEC = 110        # 总结后等待秒数，需避开 action_guard 95 秒同命令短窗
...
CMD_YUANYING = ".元婴出窍"
CMD_YUANYING_SECT_RETREAT = ".元婴闭关"
CMD_YUANYING_STATUS = ".元婴状态"
CMD_EXPLORE_RIFT = ".探寻裂缝"
CMD_REBIRTH_REQUEST = ".夺舍重生"
CMD_REBIRTH_SELECT_PREFIX = ".重生"
CMD_WENDAO = ".问道"
CMD_DUEL = ".斗法"
...
CMD_WANXIN_CANCEL_COMMISSION = ".取消解咒委托"
...
CMD_WANXIN_MOON_STATUS = ".婉影"
CMD_WANXIN_MOON_GREET = ".婉影问安"
CMD_WANXIN_MOON_SEAL = ".同参封魂"
CMD_WANXIN_MOON_JOIN = ".月下合参"
CMD_FISHING = ".钓鱼"
...
CMD_USE_HEQI_DAN = ".服用 合气丹"
CMD_EXCHANGE_HEQI_DAN_PREFIX = ".兑换 合气丹*"
CMD_SECT_DONATE_LINGSHI_PREFIX = ".宗门捐献 灵石*"
...
CMD_SECOND_SOUL_PURGE = ".元神镇魔"
CMD_SECOND_SOUL_DEMON_STATUS = ".五子同心魔"
CMD_YINDAO = ".引道"
...
CONCUBINE_HEART_CHOICE_DELAY_MIN_SEC = 6
CONCUBINE_HEART_CHOICE_DELAY_MAX_SEC = 9
CONCUBINE_VOYAGE_DEFAULT_ROUTE = "冒险"
CONCUBINE_VOYAGE_MOON_ROUTE = "月殿寻痕"
...
MULAN_CD = 12 * 3600
MULAN_JITTER_MIN_SEC = 60
MULAN_JITTER_MAX_SEC = 180
MULAN_REPLY_TIMEOUT_SEC = 180
...
CMD_HUANGLONG_CONSCRIPTION = ".黄龙征调"
...
CMD_REPLICA_XIAOJI_JOIN = ".加入小极宫"
REPLICA_SUCCESS_COOLDOWN_SEC = 125 * 60
REPLICA_XIAOJI_SUCCESS_COOLDOWN_SEC = 72 * 3600
REPLICA_ZHUIMO_SUCCESS_COOLDOWN_SEC = 2 * 60 * 60
REPLICA_CANGKUN_SUCCESS_COOLDOWN_SEC = int(2.5 * 60 * 60)
REPLICA_LUOYUN_SUCCESS_COOLDOWN_SEC = 48 * 60 * 60
...
RE_CMD_RUNTIME_HEALTH_DETAIL = re.compile(r'^\.(健康详情|运行健康详情|实时健康详情|运行详情|接手审计)$')
