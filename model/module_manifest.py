...
_MANIFESTS = (
    ...
    ModuleManifest(
        "放养",
        MODULE_KEY_MAP["放养"],
        reply_families=("ranch",),
        replay_required=False,
        duplicate_guard="passive_result",
        archived=True,
        archive_reason="旧 .一键放养 自动链已归档；等待万兽谷·驭灵行迹 MiniApp Gate C。",
    ),
    ...
    ModuleManifest("婉心封魂", MODULE_KEY_MAP["婉心封魂"], replay_modules=("wanxin",), reply_families=("wanxin_panel", "wanxin_visit", "wanxin_protect", "wanxin_deduce", "wanxin_commission", "wanxin_cancel", "wanxin_accept", "wanxin_assist_identify", "wanxin_assist_banner", "wanxin_assist_strip", "wanxin_moon_panel", "wanxin_moon_greet", "wanxin_moon_seal", "wanxin_moon_join"), send_policy=SEND_POLICY_PASSIVE_FIRST, active_query_policy=ACTIVE_QUERY_LAST_RESORT, replay_required=False, duplicate_guard="passive_observation"),
