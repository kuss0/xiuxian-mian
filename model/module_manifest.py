...
_MANIFESTS = (
    ModuleManifest(
        ...
        archive_reason="旧版灵树灌溉已停止；当前仅接入落云宗新版云梦灵眼定脉。",
    ),
    ...
    ModuleManifest("慕兰", MODULE_KEY_MAP["慕兰"], replay_modules=("mulan",), reply_families=("mulan_panel", "mulan_collect", "mulan_judge", "mulan_publish"), replay_required=False, duplicate_guard="phase"),
