(function(){
  ...
  function renderFishingConfigPanel(){
    ...
    var chumDisabled = fishing.auto_chum_enabled ? '' : ' disabled';
    panel.innerHTML =
      ...
      '<label class="field-label"><span>窝料</span><select class="text-input" name="chum_name"'+chumDisabled+'>'+optionHtml(fishing.chum_choices || [], fishing.chum_name || '无')+'</select></label>'+
  ...
  async function submitFishingConfig(event){
    ...
    var payload = {
      ...
      chum_name: chumEnabled ? form.querySelector('select[name="chum_name"]').value : '无',
  ...
  document.addEventListener('change', function(event){
    ...
    var select = form && form.querySelector('select[name="chum_name"]');
    if(select){
